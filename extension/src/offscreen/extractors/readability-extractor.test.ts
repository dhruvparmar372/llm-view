...
<body>
  <article>
    ...
    <p>By John Doe</p>
    <p>This is the first paragraph of the article. It contains enough text to be considered meaningful content by the parser. The readability parser typically needs a reasonable amount of content to extract properly.</p>
